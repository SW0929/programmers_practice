...
// BST_DFS 클래스 정의
class BST_DFS_search_recursion {
    public int data;  // 요솟값
    public int left;  // 왼쪽 요소의 연결 정보
    public int right; // 오른쪽 요소의 연결 정보
}

public class BST_element_search_recursion {
    // 이진 탐색 트리의 실체가 되는 배열(요소 수는 최대 10)
    public static BST_DFS_search_recursion[] tree = new BST_DFS_search_recursion[10];
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < tree.length; i++){
            tree[i] = new BST_DFS_search_recursion();
        }
